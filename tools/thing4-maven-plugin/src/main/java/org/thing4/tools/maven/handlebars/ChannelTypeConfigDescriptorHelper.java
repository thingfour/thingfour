...
public class ChannelTypeConfigDescriptorHelper implements Helper<ChannelType> {

  private final List<ConfigDescription> descriptors;

  public ChannelTypeConfigDescriptorHelper(List<ConfigDescription> descriptors) {
    this.descriptors = descriptors;
  }

  @Override
  public Object apply(ChannelType context, Options options) throws IOException {
