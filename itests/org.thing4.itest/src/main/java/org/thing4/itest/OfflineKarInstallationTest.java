...
import org.thing4.bddhab.rest.client.ApiClient;
import org.thing4.bddhab.rest.client.ApiException;
import org.thing4.bddhab.rest.client.v31.AddonsApi;
import org.thing4.bddhab.rest.client.v31.model.Addon;
...
public abstract class OfflineKarInstallationTest {
  ...
  @Container
  protected OpenHABContainer<?> container = new OpenHABContainer<>(System.getProperty("openhab.version", "3.0.4"))
  ...
  public void installAddonKar() throws Exception {
    Pattern pattern = Pattern.compile(".*Added feature repository 'mvn:org.thing4/.*" + kar);
    ...
    File[] karFiles = new File("target/additional-resources")
      .listFiles(file -> file.getName().matches("org.thing4.kar." + kar + "-.*\\.kar"));
